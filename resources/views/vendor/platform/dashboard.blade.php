...
@section('aside')
    <div style="background-color: #d7d7d7" class="aside col-xs-12 col-xxl-2 d-flex flex-column me-auto" data-controller="menu">
        ...
        <nav class="aside-collapse w-100 d-xl-flex flex-column collapse-horizontal" id="headerMenuCollapse">
            ...
            <footer style="background-color: #d7d7d7"  class="position-sticky bottom-0">
